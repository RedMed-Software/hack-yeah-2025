...
export default function AddNewEventPage() {
    ...
    const addFocusArea = () => {
        if (currentFocusArea && !eventData.focusAreas.includes(currentFocusArea)) {
            setEventData(prev => ({
                ...prev,
                focusAreas: [...prev.focusAreas, currentFocusArea]
            }));
            setCurrentFocusArea('');
        }
    };
            ...
            <div className={styles.container}>
                <header className={styles.header}>
                    ...
                    <p className={styles.subtitle}>
                        Wypełnij formularz, aby dodać nowe wydarzenie do platformy wolontariatu
                    </p>
                </header>
                        ...
                        <div className={styles.fieldGrid}>
                            <div className={styles.field}>
                                <label className={styles.label} htmlFor="dateStart">
                                    <p>Data rozpoczęcia <span className={styles.required}>*</span></p>                                </label>
                                <input
                                    id="dateStart"
                                    type="date"
                                    className={styles.input}
                        ...
                        {eventData.tasks.map((task, index) => (
                            <div key={index} className={styles.taskCard}>
                                ...
                                <div className={styles.fieldGrid}>
                                    <div className={styles.field}>
                                        <label className={styles.label}>
                                            <p>Tytuł zadania <span className={styles.required}>*</span></p>
                                        </label>
                                        <input
                                            type="text"
                                            className={styles.input}
                                    ...
                                    <div className={styles.field}>
                                        <label className={styles.label}>
                                            <p>Lokalizacja <span className={styles.required}>*</span></p>
                                        </label>
                                        <input
                                            type="text"
                                            className={styles.input}
                                ...
                                <div className={styles.field}>
                                    <label className={styles.label}>
                                        <p>Opis zadania <span className={styles.required}>*</span></p>
                                    </label>
                                    <textarea
                                        className={styles.textarea}
                                ...
                                <div className={styles.fieldGrid}>
                                    <div className={styles.field}>
                                        <label className={styles.label}>
                                            <p>Data <span className={styles.required}>*</span></p>
                                        </label>
                                        <input
                                            type="date"
                                            className={styles.input}
                                    ...
                                    <div className={styles.field}>
                                        <label className={styles.label}>
                                            <p>Godzina rozpoczęcia <span className={styles.required}>*</span></p>
                                        </label>
                                        <input
                                            type="time"
                                            className={styles.input}
                                    ...
                                    <div className={styles.field}>
                                        <label className={styles.label}>
                                            <p>Godzina zakończenia <span className={styles.required}>*</span></p>
                                        </label>
                                        <input
                                            type="time"
                                            className={styles.input}
                                ...
                                <div className={styles.fieldGrid}>
                                    <div className={styles.field}>
                                        <label className={styles.label}>
                                            <p>Minimalny wiek <span className={styles.required}>*</span></p>
                                        </label>
                                        <input
                                            type="number"
                                            className={styles.input}
                                            value={task.volunteerNeeds.minAge}
