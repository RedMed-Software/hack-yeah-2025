...
namespace HackYeah2025.Migrations
{
    ...
    [Migration("20251004234640_EventAccount")]
    partial class EventAccount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HackYeah2025.Infrastructure.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "volunteer",
                            PasswordHash = "100000:XORHTLO8nJfD9B1cZfh7+A==:NBfo8wPwybo+6tgMFZ84YybwrrxetJUX4lU1tsaaYmc=",
                        ...
                        new
                        {
                            ...
                            PasswordHash = "100000:8n00Ay75UsKGduxfGb9a1w==:MTsTCwrRNKiPpvJvA8/B+BVmqX6JBZcJ8EEayFp4JH4="
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "coordinator",
                            PasswordHash = "100000:hRvJulR5NfiJ7NRG9w+Wuw==:bA+9KNEhAoczFWRBlStH8mVqIA/og2r4aRSkSwDBVr0="
                        });
                });
