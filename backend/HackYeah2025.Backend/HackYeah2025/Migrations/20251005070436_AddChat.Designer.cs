...
namespace HackYeah2025.Migrations
{
    ...
    [Migration("20251005070436_AddChat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HackYeah2025.Infrastructure.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "volunteer",
                            PasswordHash = "100000:Ek7Wn4mtzFo+k6869QT/ug==:rmtr+o5aVrXtqsKKr7nVnUhRw1ZllNf268BhmmzRNqM=",
                        ...
                        new
                        {
                            ...
                            PasswordHash = "100000:Llt1a+Y1yIi5bGpikrFQqA==:aifcdSTI7N+WwXcnXJjPd0ABL70PeNKur8IaycaxZvA="
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "coordinator",
                            PasswordHash = "100000:cJrjsCILamimtHANvNqiAw==:sXRa4ruLAcu+uJDvBO4Rev19Bf4i74yetT+5ISX9DH4="
                        });
                });
            ...
            modelBuilder.Entity("HackYeah2025.Infrastructure.Models.Chat", b =>
                {
            ...
            modelBuilder.Entity("HackYeah2025.Infrastructure.Models.ChatAccount", b =>
                {
                    b.Property<Guid>("ChatId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ChatAccounts", (string)null);
                });

            modelBuilder.Entity("HackYeah2025.Infrastructure.Models.ChatMessage", b =>
                {
            ...
            modelBuilder.Entity("HackYeah2025.Infrastructure.Models.EventsAccount", b =>
                {
                    b.Property<Guid>("EventId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EventsAccounts", (string)null);
                });
            ...
            modelBuilder.Entity("HackYeah2025.Infrastructure.Models.ChatAccount", b =>
                {
                    ...
                    b.HasOne("HackYeah2025.Infrastructure.Models.Chat", "Chat")
                        .WithMany("ChatAccounts")
