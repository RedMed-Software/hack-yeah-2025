...
public sealed class HackYeahDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Organization>().HasData(
            ...
            {
                Id = orgId,
                Name = "Fundacja Dobrych Wydarze�",
                FoundedYear = 2015,
                Location = "Warszawa, Polska",
                Programs = "Pomoc spo�eczna, organizacja wydarze� charytatywnych",
                Mission = "Wspieranie spo�eczno�ci lokalnych przez organizacj� event�w dobroczynnych",
        ...
        modelBuilder.Entity<Organizer>().HasData(new Organizer
        {
            ...
            Languages = "PL, EN",
            Specializations = "Organizacja event�w"
        });
